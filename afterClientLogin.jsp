...
<head>
  ...
  <script src="https://kit.fontawesome.com/64d58efce2.js" crossorigin="anonymous"></script>
    <title>FreeLation - Client Login.</title>
...
<body>
        ...
        <div class="logo">
          <img src="Images/logo.png">
            ...
            <ul>
                ...
                <li><a href="clientPostProject.jsp">Post Project</a></li>
                <li><form action="clientHireFreelancer" method="get"><input type="submit" value="Hire"></form></li>
    ...
    <form action="" method="get" class="search-bar">
      ...
      <button type="submit"><img src="Images/search-icon-red-clip-art-283911-removebg-preview.png"></button>
        ...
        <div class="payment"><div>Pay Freelancer</div><form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_KY2id81uNngwlH" async> </script> </form></div>
    </section>
    ...
    <section id="category" class="Category">
        ...
        <section class="campus">
          ...
          <div class="campus-col">
            <img src="./Images/solidpixels-iq2RzBMj-Wg-unsplash.jpg">
            <div class="layer">
              <h3>Web Designing</h3>
            </div>
          </div>
